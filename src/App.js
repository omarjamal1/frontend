...
class Dashboard extends Component {
  ...
  addWidget(widget){
    let url = 'http://dev.agviewer.net/charts/' + this.props.tabId + '/';
    fetch(url, 
      {
        method:'POST',
  ...
  loadSensors() {
    ...
    let url = 'http://dev.agviewer.net/sensors/';
    fetch(url)
    .then((response) => {
      return response.json();
    })
...
class App extends Component {
  ...
  signin = (credentials) => {
    ...
    let url = 'http://dev.agviewer.net/login/';
    fetch(url, 
      {
        method:'POST',
  ...
  loadTabs(){
    fetch('http://dev.agviewer.net/tabs/')
    .then((response) => {
      return response.json();
    })
    .then((tabs) => {
